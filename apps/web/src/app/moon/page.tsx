        ...
        <svg viewBox={`0 0 ${size} ${size}`} width={size} height={size}>
            <defs>
                <radialGradient id="moonGlow" cx="50%" cy="30%" r="70%">
                    ...
                    <stop offset="100%" stopColor="#C1A87D" stopOpacity="0.7" />
                </radialGradient>
            ...
            <circle cx={cx} cy={cy} r={r + 8} fill="none" stroke="#C1A87D" strokeWidth="1" opacity="0.1" />
            <circle cx={cx} cy={cy} r={r + 16} fill="none" stroke="#C1A87D" strokeWidth="0.5" opacity="0.05" />
            ...
            <g clipPath="url(#moonClip)" opacity="0.3">
                {craters.map((c, i) => (
                    <circle key={i} cx={c.x} cy={c.y} r={c.r} fill="none" stroke="#A88D5D" strokeWidth="1" />
                ))}
            </g>
