...
import { computeBestObservationTime } from "@hilal/astronomy";
...
export function BestTimeCard({ date, location }: BestTimeCardProps) {
    ...
    return (
        <div className="breezy-card animate-breezy-enter">
            <div className="flex items-center gap-2 mb-3">
                <div
                    className="w-7 h-7 rounded-lg flex items-center justify-center"
                    style={{ background: "color-mix(in oklch, var(--gold) 15%, transparent)" }}
                >
            ...
            {result.viable ? (
                ...
                >
                    No viable observation window for this date/location.
                </div>
            )}
        </div>
    );
